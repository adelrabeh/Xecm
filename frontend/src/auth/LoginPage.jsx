...
export default function LoginPage() {
  ...
  return (
    <div dir={isRTL?'rtl':'ltr'} className="min-h-screen bg-gradient-to-br from-gov-900 to-primary-700 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">{lang==='ar'?'دارة الملك عبدالعزيز':'Darah Foundation'}</h1>
          <p className="text-gray-500 text-sm mt-1">{lang==='ar'?'نظام إدارة المحتوى المؤسسي':'Enterprise Content Management'}</p>
        </div>
