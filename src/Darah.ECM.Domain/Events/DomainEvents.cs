...
namespace Darah.ECM.Domain.Events.Records
{
    public record RecordDeclaredEvent(
        Guid DocumentId, string DocumentNumber, int RecordClassId, int DeclaredBy) : DomainEvent
...
namespace Darah.ECM.Domain.Events.Workspace
{
    public record WorkspaceCreatedEvent(
        Guid WorkspaceId, string WorkspaceNumber, string TypeCode, int CreatedBy) : DomainEvent
    ...
    public record MetadataSyncFailedEvent(
        Guid WorkspaceId, string ExternalSystemId, string ErrorMessage) : DomainEvent
