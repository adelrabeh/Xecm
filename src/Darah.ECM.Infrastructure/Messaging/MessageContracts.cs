...
public sealed class OcrCompletedConsumerInCore : IConsumer<OcrCompletedEvent>
{
    ...
    public async Task Consume(ConsumeContext<OcrCompletedEvent> ctx)
    {
        ...
        // OCR results stored in-memory until schema migration adds columns
        // TODO: Add ExtractedText column to Documents table
        Console.WriteLine($"OCR completed for document {msg.DocumentId}: confidence={msg.Confidence:P0}");sTransit;
