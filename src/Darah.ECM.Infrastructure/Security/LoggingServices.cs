...
public sealed class AuditService : IAuditService
{
    ...
    public AuditService(EcmDbContext ctx, ICurrentUser user, ILogger<AuditService> log)
        { _ctx = ctx; _user = user; _log = log; }

    public async Task LogAsync(string eventType, string? entityType = null,
